...
<body class="bd-gray-50 min-h-screen">
    ...
    <header class="flex items-center justify-between p-6 pb-12">
        ...
        <div class="flex gap-4">
            @guest
            <a href="{{ route('login') }}" class="rounded-md bg-gray-200 py-2 px-4 text-gray-900 font-semibold shadow-lg hover:shadow-xl focus:shadow-xl hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition duration-200 ease-in-out">Log In</a>
            ...
            @endguest
            @auth
            <a href="{{ route('dashboard') }}" class="rounded-md bg-blue-600 py-2 px-4 text-white font-semibold shadow-lg hover:shadow-xl focus:shadow-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 ease-in-out">Dashboard</a>
            @endauth
        </div>
    </header>
</body>
