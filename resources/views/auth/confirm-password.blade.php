...
<body class="bd-gray-50 min-h-screen">
    ...
    <main class="flex flex-col justify-center p-6">
        <div class="mx-auto max-w-md">
            <svg class="mx-auto h-12 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="bg-white/80 backdrop-blur-xl mt-6 sm:mt-10 mx-auto rounded-xl shadow-xl p-6 sm:p-10 max-w-md w-full">
            <form action="{{ route('password.confirm') }}" method="post" novalidate autocomplete="off">
                ...
                <div>
                    <button type="submit" class="w-full flex justify-center items-center rounded-md bg-blue-600 py-2 px-4 text-white font-semibold shadow-lg hover:shadow-xl focus:shadow-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 ease-in-out">Confirm</button>
                </div>
            </form>
